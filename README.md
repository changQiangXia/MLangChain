...
┌─────────────────────────────────────────────────────────┐
│                    Task Classifier                      │
│         (识别任务类型: CODE/REASONING/EXPLANATION)       │
└─────────────────────────────────────────────────────────┘
                           │
                           ▼
┌─────────────────────────────────────────────────────────┐
...
| 智能体 | 职责 | 关键能力 |
|--------|------|----------|
| **Generator** | 生成初始指令数据 | 多样化采样、多版本生成 |
| **Critic** | 多维度质量评审 | 动态评分、RAG验证、复杂度评估 |
| **Refiner** | 根据反馈优化数据 | 迭代改进、指令进化 |
...
│   ├── graph/                   # 工作流定义
│   │   ├── workflow.py          # V1 工作流
│   │   └── workflow_v2.py       # V2 工作流 (Best-of-N)
│   │
│   ├── tools/                   # 工具模块
...
- **LangChain/LangGraph 团队**：优秀的框架设计
- **智谱 AI**：强大的中文 LLM 支持
- **Tavily**：高质量的搜索服务
